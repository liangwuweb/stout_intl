...
<header id="header" class="ex-header">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header-title mb-3">About our community</h1>
                <p class="page-header-text">Our community culture, and how we communicate</p>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
