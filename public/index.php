        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <a class="btn btn-lg btn-primary btn-header mt-n2" href="<?php echo url_for('/about.php'); ?>">Leaern More<svg class="svg-inline--fa fa-arrow-right fa-w-14 ml-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
