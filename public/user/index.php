...
<?php 
//require_once(SHARED_PATH . '/global_header.php'); 
...
<div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">TOTAL POSTS
                                    </div>
    ...
    <?php 
//require_once(SHARED_PATH . '/global_footer.php'); 
